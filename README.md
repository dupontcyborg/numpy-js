...
A faithful NumPy 2.0+ implementation for TypeScript/JavaScript, validated against Python NumPy. **141 of 333 NumPy functions (42.3% complete)** covering array creation, manipulation, linear algebra, reductions, and more.
...
**Overall: 141/333 functions (42.3% complete)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 141/333 (42%) | ~20% | Different | ML-focused |
