...
![numpy api coverage](https://img.shields.io/badge/numpy_api_coverage-69%20%25-yellow)
...
- **📊 Extensive API** — **230 of 333 NumPy functions (69.1% coverage)**
...
**Overall: 230/333 functions (69.1% complete)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 230/333 (69%) | ~20% | Different | ML-focused |
