...
A faithful NumPy 2.0+ implementation for TypeScript/JavaScript, validated against Python NumPy. **153 of 333 NumPy functions (45.9% complete)** covering array creation, manipulation, linear algebra, reductions, and more.
...
**Overall: 153/333 functions (45.9% complete)**
...
|---------|----------|-------|---------|---------------|
| NumPy API Coverage | 153/333 (46%) | ~20% | Different | ML-focused |
